...
class Evaluation {
    ...
    public function addEvaluation($task_name, $name, $performance_average) {
        ...
        $query = "INSERT INTO evaluations (task_name, name, performance_average) VALUES ('$task_name', '$name', '$performance_average')";
        $result = $this->conn->query($query);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_evaluation'])) {
    ...
    $result = $evaluation->addEvaluation($task_name, $name, $performance_average);
